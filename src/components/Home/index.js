...
function Home() {
  ...
  return (
    <div className="App">
      <a href="https://accounts.spotify.com/en/authorize?client_id=5a308894828241d78142929accea69d7&redirect_uri=http:%2F%2Flocalhost:3000&response_type=token&state=123">
        Connect to Spotify
      </a>
